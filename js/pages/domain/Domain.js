    ...
    Gitana.Console.Pages.Domain = Gitana.CMS.Pages.AbstractDashboardPageGadget.extend(
        {
            ...
            setupToolbar: function() {
                ...
                /** TODO: no longer have getDefaultDomainId() on platform **/
                /*
                 if (this.targetObject().getId() != this.platform().getDefaultDomainId()) {
                 self.addButtons([
                 {
                 "id": "edit",
                 "title": "Edit Domain",
                 ...
                 self.onClickDelete(self.targetObject(), 'domain', self.listLink('domains'), Gitana.Utils.Image.buildImageUri('security', 'domain', 20), 'domain');
                 },
                 "requiredAuthorities" : [
                 {
                 "permissioned" : this.targetObject(),
