(function($) {
    Gitana.Console.Pages.InteractionNode = Gitana.CMS.Pages.AbstractListPageGadget.extend(
        {
            SUBSCRIPTION : "warehouse-interaction-nodes-page",

            FILTER : "interaction-nodes-interaction-list-filters",
            ...
            setup: function() {
                this.get("/warehouses/{warehouseId}/nodes/{interactionNodeId}", this.index);
            },
            ...
            setupBreadcrumb: function() {
                return this.breadcrumb(Gitana.Console.Breadcrumb.InteractionNode(this));
            },
            ...
            setupProfile: function () {
                var self = this;
                var interactionNode = self.targetObject();
                var pairs = {
                    "title" : "Overview",
            ...
            setupPage : function(el) {
                var page = {
                    "title" : "Interaction Node " + this.friendlyTitle(this.targetObject()),
                    ...
                    "dashlets" :[
                        {
                            ...
                            "grid" : "grid_12",
                            "gadget" : "pairs",
                            "subscription" : "interaction-node-profile-pairs"
                        }
                    ]
                };
    ...
    Ratchet.GadgetRegistry.register("page", Gitana.Console.Pages.InteractionNode);
