(function($) {
    Gitana.Console.Pages.InteractionPage = Gitana.CMS.Pages.AbstractListPageGadget.extend(
        {
            SUBSCRIPTION : "warehouse-interaction-pages-page",

            FILTER : "interaction-pages-interaction-list-filters",
            ...
            setup: function() {
                this.get("/warehouses/{warehouseId}/pages/{interactionPageId}", this.index);
            },
            ...
            setupBreadcrumb: function() {
                return this.breadcrumb(Gitana.Console.Breadcrumb.InteractionPage(this));
            },
            ...
            setupProfile: function () {
                var self = this;
                var interactionPage = self.targetObject();
                var pairs = {
                    "title" : "Overview",
            ...
            setupPage : function(el) {
                var page = {
                    "title" : "Interaction Page " + this.friendlyTitle(this.targetObject()),
                    ...
                    "dashlets" :[
                        {
                            ...
                            "grid" : "grid_12",
                            "gadget" : "pairs",
                            "subscription" : "interaction-page-profile-pairs"
                        }
                    ]
                };
    ...
    Ratchet.GadgetRegistry.register("page", Gitana.Console.Pages.InteractionPage);
