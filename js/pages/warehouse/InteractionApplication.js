(function($) {
    Gitana.Console.Pages.InteractionApplication = Gitana.CMS.Pages.AbstractListPageGadget.extend(
        {
            SUBSCRIPTION : "warehouse-interaction-applications-page",

            FILTER : "interaction-applications-interaction-list-filters",
            ...
            setup: function() {
                this.get("/warehouses/{warehouseId}/applications/{interactionApplicationId}", this.index);
            },
            ...
            setupBreadcrumb: function() {
                return this.breadcrumb(Gitana.Console.Breadcrumb.InteractionApplication(this));
            },
            ...
            setupProfile: function () {
                var self = this;
                var interactionApplication = self.targetObject();
                var pairs = {
                    "title" : "Overview",
                    "icon" : Gitana.Utils.Image.buildImageUri('objects', 'interaction-application', 20),
                    "alert" : "",
                    "items" : []
                };
                this._pushItem(pairs.items, {
                    "key" : "ID",
                    "value" : interactionApplication.getId()
                });
                this._pushItem(pairs.items, {
                    "key" : "Key",
                    "value" : interactionApplication.get('key')
                });
                this._pushItem(pairs.items, {
                    "key" : "Last Modified",
                    "value" : "By " + interactionApplication.getSystemMetadata().getModifiedBy() + " @ " + interactionApplication.getSystemMetadata().getModifiedOn().getTimestamp()
                });

                this.pairs("interaction-application-profile-pairs", pairs);
            },
            ...
            setupPage : function(el) {
                var page = {
                    "title" : "Interaction Application " + this.friendlyTitle(this.targetObject()),
                    ...
                    "dashlets" :[
                        {
                            ...
                            "grid" : "grid_12",
                            "gadget" : "pairs",
                            "subscription" : "interaction-application-profile-pairs"
                        }
                    ]
                };
    ...
    Ratchet.GadgetRegistry.register("page", Gitana.Console.Pages.InteractionApplication);
