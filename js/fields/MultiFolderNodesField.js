(function($) {
     ...
     */
    {
        ...
        branch: function()
        {
            return Chain(this.context.getBranch());
        },
        ...
        onNodeCreated: function(node, index) {
            ...
            var folder = self.context;

            node.associateOf(folder,"a:child")
        },
    ...
    */
    ...
    Alpaca.registerTemplate('multiFolderNodesUploadTemplate', Alpaca.Fields.MultiNodesField._TEMPLATE_UPLOAD_TEMPLATE);
    Alpaca.registerTemplate('multiFolderNodesDownloadTemplate', Alpaca.Fields.MultiNodesField._TEMPLATE_DOWNLOAD_TEMPLATE);
    Alpaca.registerTemplate("controlFieldMultiFolderNodes", Alpaca.Fields.MultiNodesField._TEMPLATE_MULTINODES);
