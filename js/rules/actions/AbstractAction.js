(function($)
{
    ...
    Gitana.Console.Rule.AbstractAction = Base.extend({
        ...
        constructor: function(config)
        {
            ...
            if (!config) {
                console.log("Abstract Action: missing config");
            }
            if (!config.id) {
                console.log("Abstract Action: missing config id");
            }
         ...
         * EXTENSION POINT
         *
         * This gets called when an action of this type is being added.
         */
