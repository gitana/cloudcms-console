(function($) {
    Gitana.Console.Pages.GitanaApplicationSelector = Gitana.CMS.Pages.AbstractListPageGadget.extend(
    {
        TEMPLATE : "components/gitana-application-selector",

        SUBSCRIPTION : "application-picker",

        DISPLAY_LIST_FILTER: true,

        FILTER : "application-candidates-list-filters",
        ...
        setupList: function(el) {
            ...
            list["columns"] = [
                ...
                },
                {
                    ...
                    "property": function(callback) {
                        ...
                        var value = "<a class='gitana-selector-action application-action gitana-selector-select application-select' data-target-application-id='" + id + "' data-target-application-title='" + title + "'><span>Select</span></a>";
                        callback(value);
                    }
                }
            ];
            ...
            list["loadFunction"] = function(query, pagination, callback) {
                ...
                Chain(self.platform()).queryApplications(_query, self.pagination(pagination)).then(function() {
                    callback.call(this);
                });
            };
        ...
        processList: function(el) {
            ...
            $("body").undelegate(".application-select", "click").delegate(".application-select", "click", function() {

                var control = $(this);
                var id = control.attr("data-target-application-id");
                var title = control.attr("data-target-application-title");

                self.selectHandler.call(this, id, title);
            })
        },

        setupGitanaApplicationSelector : function(el) {
            ...
            this.observable('applicationselector').set(page);
        },
            ...
            self.loadContext(el, function() {
                ...
                self.checkAuthorities(function(isEntitled, error) {
                    if (isEntitled) {
                        ...
                        // set up the page
                        self.setupGitanaApplicationSelector(el);
    ...
    Ratchet.GadgetRegistry.register("applicationselector", Gitana.Console.Pages.GitanaApplicationSelector);
