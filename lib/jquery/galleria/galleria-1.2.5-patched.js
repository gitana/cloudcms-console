        ...
        update: function() {
            ...
            $.each( self._thumbnails, function( i, thumb ) {
                if ( thumb.ready ) {
                    ...
                    w += 1; // Fixed width issue with firefox 13
                    hooks[ i+1 ] = w;
                    ...
                    if ( ( !this.width || !this.height ) ) {
                        ...
                        if ( !reload ) {
                            ...
                            window.setTimeout((function(image, src) {
                                return function() {
                                    image.attr('src', src + '&t=' + Utils.timestamp() );
                                };
                            }( $(this), src )), 50);
                        } else {
                        ...
                        return;
                        */
                        // This in-memory reload seems to work for Chrome - Dr. Q.
