(function($, window) {
    ...
    Gitana.CMS.ImplicitFlowAuthenticator = Gitana.CMS.AbstractOAuth2Authenticator.extend({
        ...
        preload: function()
        {
            ...
            var _accessToken = Gitana.getCurrentHashStringParameter("access_token");
            if (_accessToken)
            {
        ...
        authenticate: function(context, successCallback, failureCallback) {
            ...
            if (context.topRatchet().gitanaAuthenticated) {
                successCallback();
                return;
            }
